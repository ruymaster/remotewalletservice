...
namespace CryptoWallet.Model
{
    ...
    public class CurrencySymbol
    {
        ...
        public const string BEP2NativeSymbolName = "BNB";
        public const string ErlondSymbolName = "eGLD";

        //public const string 

        public static CurrencySymbol BSCNativeCoin { get; } = new CurrencySymbol(BEP2NativeSymbolName);        
